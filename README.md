...
![8-Bit Computer](ben_eater_8_bit_computer.jpeg)
...
- Understanding how to document projects for future reference.
- Master Obsidian and Multi-Markdown formatting.

## Documentation Approach
I will also use ChatGPT and ProWritingAid to create templates and grammar structures quickly, easing up the documentation process. However, I will be the one writing most of the text.
